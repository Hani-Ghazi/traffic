...
function drivingEdges() {
  var res = [];
  return models.bus.find({}) // get all buses
    .then(function (buses) {
          ...
          .then(function (stops) {
            ...
            var timer = setInterval(function () {
              if(index == size)
                ...
                getDistance(res[index].origin, res[index].destination, res[index], 'DRIVING');
                index++;
              }
            }, 30);
          });
...
module.exports = {
  updateGraphWieghts: function () {
    if (!gmAPI)
      initMap();
    console.log(getDistance('33.513489,36.28987|33.513819, 36.295341', '33.531625, 36.240269'));
